...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/', PasswordResetConfirmView.as_view(template_name='password_reset_form.html', success_url='iniciar_sesion/reset_password_complete/'), name='password_reset_confirm'),
